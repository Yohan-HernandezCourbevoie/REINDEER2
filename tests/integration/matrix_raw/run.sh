...
LOCAL_FOLDER="tests/integration/matrix_raw"
...
RUST_LOG=warn $reindeer2 query --fasta $QUERY_INPUT --index ./integration_test_index --output-format abundance-matrix-raw --output $QUERY_OUTPUT
