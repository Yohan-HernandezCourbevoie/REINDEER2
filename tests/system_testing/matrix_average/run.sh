...
LOCAL_FOLDER="tests/system_testing/matrix_average"
...
RUST_LOG=warn $reindeer2 query --fasta $QUERY_INPUT --index ./integration_test_index --output-format abundance-matrix-average --output $QUERY_OUTPUT
