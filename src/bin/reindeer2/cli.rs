...
pub struct IndexArgs {
    ...
    #[arg(long)]
    pub kmer_sampling: Option<u64>,

    /// k-mer sampling strategy
    #[arg(long)]
    pub minimizer_sampling: Option<u64>,

    // To gain some space, some users remove the header of their fasta/q files.
    ...
    /// Experty parameter: allows the count to be in header right after the ">", e.g. ">ka:f:18"
    #[arg(long, default_value_t = false)]
